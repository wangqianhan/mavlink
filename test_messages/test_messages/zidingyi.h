/** @file
 *	@brief MAVLink comm protocol generated from zidingyi.xml
 *	@see http://mavlink.org
 */
#ifndef MAVLINK_ZIDINGYI_H
#define MAVLINK_ZIDINGYI_H

#ifndef MAVLINK_H
    #error Wrong include order: MAVLINK_ZIDINGYI.H MUST NOT BE DIRECTLY USED. Include mavlink.h from the same directory instead or set ALL AND EVERY defines from MAVLINK.H manually accordingly, including the #define MAVLINK_H call.
#endif
